...
SUPPORTED_ZP_READ_VERSIONS = frozenset({ZP_VERSION_V1})
SUPPORTED_ZP_WRITE_VERSIONS = frozenset({ZP_VERSION_V1})
SUPPORTED_ZP_VALIDATE_VERSIONS = frozenset({ZP_VERSION_V1})
ZP_EXTENSION = ".zp"
